...
<section class="container mx-auto p-2 md:p-4" id="projects">
	...
	<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-3">
		...
		<!-- see all card -->
		<button class="btn btn-secondary h-full card rounded-lg">
